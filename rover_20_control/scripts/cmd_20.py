...
def callback_cmd(data):
	#joystick
	twist_cmd.linear.x = data.linear.x * 120 #80  
	twist_cmd.angular.z = data.angular.z * 120 #80

def callback_nav(data):
	#autonomous
	twist_nav.linear.x = data.linear.x * 120 #80
	twist_nav.angular.z = data.angular.z * 120 #80
