...
class arm_serial(object):
	def __init__(self):
		...
		self.joint1 = 0
		self.joint2 = 0                  #initial degree value of joint2
	...
	def main(self):
		...
		while not rospy.is_shutdown():
			...
			self.pub1.publish(self.joint1*math.pi/180)
			self.pub2.publish(self.joint2*math.pi/180)
			self.pub3.publish(self.joint3*math.pi/180)
			self.pub4.publish(self.joint4*math.pi/180)
			self.pub5.publish(self.joint5*math.pi/180)
			self.pub6.publish(self.joint6*math.pi/180)
