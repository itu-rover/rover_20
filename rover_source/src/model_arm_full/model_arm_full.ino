...
void loop() {
  ...
  //sensorValue1 = constrain(sensorValue2, 1079, 1193);
  //sensorValue1 = constrain(sensorValue3, 1268, 1139);
  //sensorValue1 = constrain(sensorValue4, 1140, 1125);
  //sensorValue1 = constrain(sensorValue5, 870, 550);
...
/*String  finalString1=processValue(sensorValue1);

String  finalString2=processValue(sensorValue2);

String  finalString3=processValue(sensorValue3);

String  finalString4=processValue(sensorValue4);

String  finalString5=processValue(sensorValue5);
  
String finalString6=processValue(sensorValue6);*/

//char finalChar1[4], finalChar2[4],finalChar3[4],finalChar4[4],finalChar5[4],finalChar6[4];

  

  int str_len = 4; // finalString1.length() + 1 ;
  //finalString1.toCharArray(finalChar1, str_len);
 // str_msg.data = finalChar1;
  //chatter.publish( &str_msg );
  //nh.spinOnce();

   //int str_len =  finalString2.length() + 1 ;
  //finalString2.toCharArray(finalChar2, str_len);
  //str_msg.data = finalChar2;
  //chatter.publish( &str_msg );
  //nh.spinOnce();

   //int str_len =  finalString3.length() + 1 ;
  //finalString3.toCharArray(finalChar3, str_len);
 // str_msg.data = finalChar3;
  //chatter.publish( &str_msg );
  //nh.spinOnce();

   //int str_len =  finalString4.length() + 1 ;
  //finalString4.toCharArray(finalChar4, str_len);
  //str_msg.data = finalChar4;
  //chatter.publish( &str_msg );
  //nh.spinOnce();

   //int str_len =  finalString5.length() + 1 ;
  //finalString5.toCharArray(finalChar5, str_len);
  //str_msg.data = finalChar5;
  //chatter.publish( &str_msg );
  //nh.spinOnce();

   //int str_len =  finalString6.length() + 1 ;
  
  finalString.toCharArray(finalChar, 27);
  
  //finalChar = finalChar1 + finalChar2 + finalChar3 + finalChar4 +finalChar5 + finalChar6 ;
