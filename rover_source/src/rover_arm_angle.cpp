...
pub1 = rospy.Publisher("/arm19_serial", String, queue_size=50)
...
void callback(data){
    ...
    std::cout << "S"+joint1_str+" "+joint2_str+" "+joint3_str+" "+joint4_str+" "+joint5_str+" "+joint6_str+" "+gripper_str+"C"+"F" << std:: endl ;
...
int main(){
    ros::init(argc, argv, "rover_joint_angles") ;
    ros::NodeHandle node_handle;
    ros::Subscriber joy_sub = node_handle.subscribe("/gripper_command19",1,callback);
    }

string floattostring(float joint){
