...
class status_handler:
    def __init__(self):
        ...
        self.findArtagTimeout = rospy.get_param('RoverSmach/timeouts/findArtagTimeout',600000)
        self.reachArtagTimeout = rospy.get_param('RoverSmach/timeouts/reachArtagTimeout',600000)
        self.approachTimeout = rospy.get_param('RoverSmach/timeouts/approachTimeout', 1200000)

        self.gpsReached = False
        self.artagDetected = False
        self.artagReached = False #False
        ...
        self.movementAttribute = rospy.get_param('RoverSmach/attributes/movementAttribute',0)			#0 for pure navigation, 1 for navigation + artag searching.     #0 da calisti
    ...
    def start(self):
    	...
    	self.artag_detect_topic = rospy.get_param('RoverSmach/sub_topics/sub_artag_detect','/px_topic') 
    	self.artag_reach_topic = rospy.get_param('RoverSmach/sub_topics/sub_ArTag_reach','/artag_reach_topic')     #sub_reach_artag
