...
def CreateStateMachine():
	...
	with sm_rover:
		...
		smach.StateMachine.add('FIND_ARTAG',FIND_ARTAG(),
							   transitions={'SUCCESS': 'REACH_ARTAG', 'FAIL': 'ERROR', 'REPEAT': 'FIND_ARTAG', 'GO_APPROACH':'APPROACH'})

		smach.StateMachine.add('APPROACH', APPROACH(),
							   transitions={'SUCCESS': 'PASS_GATE', 'FAIL': 'ERROR', 'REPEAT': 'APPROACH', 'BACK':'FIND_ARTAG'})
