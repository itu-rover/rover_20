...
class Node():
	def __init__(self, iter_start = 0, iter_end = 0, index = 0, nodes_in_row = 0, node_yaw = 0, cost_yaw = 0, min_dist = 0):
	...
	def cost_function(self):
		...
		self.cost = self.nodes_in_row / (self.cost_yaw + 0.0000001)

	def print_me(self):
		print("Index: {}\nIter start: {}\nIter end: {}\nMin dist: {}\nNode yaw: {}\nCost yaw: {}\nNodes in row: {}\nCost: {}\nCheck Nodes: {}\n".format(
			self.index, self.iter_start, self.iter_end, self.min_dist, self.node_yaw, self.cost_yaw, self.nodes_in_row, self.cost, self.check_nodes))