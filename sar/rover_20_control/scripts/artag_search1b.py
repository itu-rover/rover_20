...
class GoForwardAvoid():
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            rospy.Subscriber('/stage_counter_topic', String, self.stageSubscriber) #stage counter
            ...
            if(self.state.state==self.state.FIND_ARTAG):
                ...
                if self.servo_rotated == True and self.rotate_once == 1:
                    self.rotate(180)
